...
<body>
    <div align="center">
        ...
        <h3>Rorkorder of Purchase Requisitions</h3>
   ...
   <tr>
    ...
    <br/>
      ...
      foreach ($list as $row)
      {
         //echo "<table border=1>";
         echo "<tr>";
         $a="<td><a class='iframe' href=".base_url()."index.php/purchase_controller/workorder_detail/".$row->workorder_of_purchase_id.">".$row->workorder_of_purchase_id."</a>&nbsp;<br></br></td>";
		 echo $a;
         ...
         {
            $a="<td><a href=".base_url()."index.php/purchase_controller/workorder_approve_storemanager/".$row->workorder_of_purchase_id.">Click To Approve</a>&nbsp;<br></br></td>";
            echo $a;
         }
		 echo "</tr>";
     }
