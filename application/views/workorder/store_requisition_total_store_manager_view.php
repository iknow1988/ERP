...
<body>
    <?php echo form_open('workorder_controller/store_requisition_approve_store_manager');?>
    <div align="center">
   ...
   <tr>
    ...
    <br/>
      ...
      foreach ($list as $row)
      {
         ...
         if($row->status=="approved by Marketing Supervisor")
         {
            $a="<td><a href=".base_url()."index.php/workorder_controller/store_requisition_approve_store_manager/".$row->store_requisition_id.">Click To Approve</a>&nbsp;<br></br></td>";
            echo $a;
         }
         else
         {
