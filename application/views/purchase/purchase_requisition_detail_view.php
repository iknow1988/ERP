...
<body>
	...
	<?php $p_id = $list[0]->purchase_requisition_id;
		  $this->session->set_userdata('p_id',$p_id);
	?>
	 <?php echo form_open('purchase_controller',$p_id);?>
   ...
   <tr>
    ...
    <br/>
      ...
      foreach ($list as $row)
      {
		//$p_id = $row->purchase_requisition_id;
		//$this->session->set_flashdata('id', $row->purchase_requisition_id);
         //echo "<table border=1>";
         echo "<tr>";
...
<div align="center">
<h><input type="submit"  class="callbacks" name="approve" id="approve" value="approve" /></h>		
  <?php echo form_close();?>
</div>
</body>
</html>
