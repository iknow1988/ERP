    ...
    <br/>
      ...
      foreach ($list as $row)
      {
        if($row->requisition_type=="client use")
        {
         ...
         {
            $a="<td><a href=".base_url()."index.php/workorder_controller/store_requisition_approve/".$row->store_requisition_id.">Click To Approve</a>&nbsp;<br></br></td>";
            echo $a;
         }
         else
         {
         ...
         if($row->status=="pending")
         {
            $a="<td><a href=".base_url()."index.php/workorder_controller/store_requisition_disapprove/".$row->store_requisition_id.">Click To Disapprove</a>&nbsp;<br></br></td>";
            echo $a;
         }
         else
         {
