    ...
    <br/>
      ...
      if(count($list)!=null)
      {
        foreach ($list as $row)
        {
         //echo "<table border=1>";
             echo "<tr>";
             $a="<td><a class='iframe' href=".base_url()."index.php/purchase_controller/purchase_requisition_detail/".$row->purchase_requisition_id.">".$row->purchase_requisition_id."</a>&nbsp;<br></br></td>";
                     echo $a;
			if($row->status==0)
			{
				echo "<td>Raised</td>";
