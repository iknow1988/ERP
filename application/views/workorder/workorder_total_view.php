<html>
 ...
 <!--link href="<?php echo base_url();?>public/css/style.css" rel="stylesheet" type="text/css" /-->
        ...
        <script type="text/javascript" src="<?php echo base_url();?>public/js/ScrollableTable.js"></script>
   ...
   <tr>
    ...
    <br/>
      ...
      foreach ($list as $row)
      {
         ...
         {
            $a="<td><a href=".base_url()."index.php/workorder_controller/workorder_approve/".$row->workorder_of_service_id.">Click To Approve</a>&nbsp;<br></br></td>";
            echo $a;
         }
         else
         {
